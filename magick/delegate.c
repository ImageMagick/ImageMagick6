...
static const char
  *DelegateMap = (const char *)
    ...
    "  <delegate decode=\"http:decode\" command=\"" DELEGATE_ESC "curl" DELEGATE_ESC " -s -k -L -o " DELEGATE_ESC "%u.dat" DELEGATE_ESC " " DELEGATE_ESC "http:%M" DELEGATE_ESC "\"/>"
    "  <delegate decode=\"https:decode\" command=\"" DELEGATE_ESC "curl" DELEGATE_ESC " -s -k -L -o " DELEGATE_ESC "%u.dat" DELEGATE_ESC " " DELEGATE_ESC "https:%M" DELEGATE_ESC "\"/>"
  ...
  *value='\0';
  ...
  switch (letter)
  {
    ...
    case 'g':
    {
      ...
      */
      (void) FormatLocaleString(value,MaxTextExtent,"%.17gx%.17g%+.20g%+.20g",
    ...
    case 'G':
    {
      ...
      */
      (void) FormatLocaleString(value,MaxTextExtent,"%.17gx%.17g",(double)
